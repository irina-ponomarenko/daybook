...
var CustomSelect = function ($) {
    var defaults = {
        ...
        return _proto.reset = function () {
            ...
            value && value.length || this._$select.val(this._$values.eq(0).val()), this._options.placeholder && (this._$select.find("[selected]").length ? this._options.placeholder = !1 : (this._$value.html(this._options.placeholder), this._$select.prop("selectedIndex", -1))), $.each(this._values, function (i, el) {
                var cssClass = _this._$values.eq(i).attr("class"),
                    $option = $('<button class="' + _this._options.block + '__option" type="button">' + el + "</button>");
                _this._$values.eq(i).attr("disabled") && $option.prop("disabled", !0), el === _this._$select.find(":selected").text().trim() ? (_this._$value.text(el).addClass(cssClass).data("class", cssClass), (_this._options.includeValue || _this._options.placeholder) && ($option.addClass(cssClass), $option.toggleClass(_this._optionSelectedModifier, _this._$values.eq(i).is("[selected]")), _this._$dropdown.append($option))) : ($option.addClass(cssClass), _this._$dropdown.append($option))
